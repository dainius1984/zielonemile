...
const Portfolio = () => {
  const portfolioCategories = [
    { id: 1, title: 'Tarasowe Projekty', slug: 'tarasy', description: 'Zobacz nasze realizacje tarasów' },
    { id: 2, title: 'Projekty Ogrodowe', slug: 'ogrody', description: 'Poznaj nasze projekty ogrodów' },
    { id: 3, title: 'Przed i Po', slug: 'przed-po', description: 'Zobacz transformacje przestrzeni' },
  ];
